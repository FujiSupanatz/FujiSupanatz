...
* **Awarded: Silver Prize (National)** – Coding Thailand 2025: AI-Driven Future for **TrueTone Project** 
* **Awarded: 2nd Runner-up (National)** – Coding War by depa for **BlinDee Project** 
* **Awarded: 1st Place (Regional)** – Coding Bootcamp Eastern Region 
* **Awarded: Special Prize "Start Up DNA"** – EEC2 Environmental Empowerment Camp 
* **International Gold Medal Certified** – Arduino Education Day Thailand 2024 (Hackathon: Innovate for Water Security) 

---

## Technical Skills & Certifications

* **Programming:** Swift (SwiftUI), Python (COMPAS-A1 Certified), C++ (Arduino/ESP32) 
* **Tools & Platforms:** Core ML, Edge Impulse, Arduino Cloud, Tinkercad (3D Design), MQTT Protocol 
* **Object Detection using YOLO** (Silpakorn University) 
